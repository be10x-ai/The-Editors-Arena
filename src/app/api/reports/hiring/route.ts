 ...
 *   ?format=pdf   → hiring evaluation report (one section per candidate)
 *   ?format=xlsx  → three-sheet workbook (summary, scorecards, criteria)
 *   ?format=registrations → the full applicant pool as a spreadsheet
 */
