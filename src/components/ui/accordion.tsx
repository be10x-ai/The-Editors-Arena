...
>(({ className, ...props }, ref) => (
  <AccordionPrimitive.Item
    ref={ref}
    className={cn(
      "glass glass-hover overflow-hidden rounded-2xl data-[state=open]:border-primary/30 data-[state=open]:bg-primary/[0.06]",
      className,
    )}
    {...props}
  />
...
>(({ className, children, ...props }, ref) => (
  ...
  >
    <div
      className={cn(
        "px-5 pb-5 pt-0 leading-relaxed text-muted-foreground sm:px-6 sm:pb-6",
        className,
      )}
    >
      {children}
